		...
		switch (_p0.ctor) {
			...
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, 'ws://127.0.0.1:3000', _p0._0)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://127.0.0.1:3000', _user$project$Main$Message);
};
